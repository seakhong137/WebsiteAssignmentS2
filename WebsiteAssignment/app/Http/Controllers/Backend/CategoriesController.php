...
class CategoriesController extends BackendController
{
    ...
    public function store(Requests\CategoryStoreRequest $request)
    {
        ...
        return redirect('/backend/categories')->with("message","New Categroy was created succcessfully");
    }
    ...
    public function update(Requests\CategoryUpdateRequest $request, $id)
    {
        ...
        return redirect('/backend/categories')->with("message","Categroy was edited succcessfully");
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(Requests\CategoryDestoryRequest $request, $id)
    {
      
      $category= Category::findOrFail($id);
     Post::where('category_id',$id)->update(['category_id'=>config('cms.default_category_id')]);
      $category->delete();
      return redirect('/backend/categories')->with("message","Categroy was deleted succcessfully");
